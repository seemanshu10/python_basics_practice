...
"""
# Reading Entire File 
with open("FileHandling/CP/Output.txt","r") as file:
    content = file.read()
    print(content)
...
with open("FileHandling/CP/empty.txt","w") as file:
    pass # crerate an empty file 

with open ("FileHandling/CP/empty.txt","r") as file:
    content = file.read()
...
with open("FileHandling/CP/single_line.txt","w") as file:
...
with open("FileHandling/CP/single_line.txt","a") as file:
...
with open("FileHandling/CP/multi_line.txt","w") as file:
...
with open("FileHandling/CP/multi_line.txt","a") as file:
