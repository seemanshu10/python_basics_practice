...
QUIZQUESTION_PATH = r"MiniProjects\01_Quiz APP with Score Tracking\data\questions.txt"

# Report Summary Path 
REPORT_PATH = r"MiniProjects\01_Quiz APP with Score Tracking\data\report_card.txt"
