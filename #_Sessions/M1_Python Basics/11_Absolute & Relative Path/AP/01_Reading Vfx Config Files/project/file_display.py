...
# relative path call 
path_assetInfo = r"#_Sessions\M1_Python Basics\11_Absolute & Relative Path\AP\01_Reading Vfx Config Files\project\assets\asset_info.txt"
read_assetInfo_file(path_assetInfo,"asset_info.txt using relative path")

# absolute path call 
path_systemConfig = r"D:\PipelineTD\python_basics_practice\#_Sessions\M1_Python Basics\11_Absolute & Relative Path\AP\01_Reading Vfx Config Files\project\assets\asset_info.txt"
