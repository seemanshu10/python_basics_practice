...
# Instructions:
Prompt the user to choose the conversion direction (Celsius to Fahrenheit or Fahrenheit to Celsius).
Prompt the user to enter the temperature.
Convert the temperature according to the chosen direction.
