"""
🎯 AP. Binary File Handling Workflow
...
Sample Output
-------------
Written data: b'Hello Binary World!'
Read data: b'Hello Binary World!'
After append: b'Hello Binary World! Appending more bytes.'
Original content: b'Hello Binary World! Appending more bytes.'
Modified content: b'Hi llo Binary World! Appending more bytes.'
"""


fileBinaryName = r"#_Sessions\M1_Python Basics\12_Operators, Strings, & Files\AP\bytes.txt"
