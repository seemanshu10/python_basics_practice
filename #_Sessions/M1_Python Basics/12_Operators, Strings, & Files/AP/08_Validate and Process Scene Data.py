"""
🎯 AP. Validate & Process Scene Data
...
Sample Output
-------------
Enter scene file name: layout_scene.txt
Error: Invalid file format. Must be a .vscene file.

Enter scene file name: layout.vscene
Enter start frame: 1050
Enter end frame: 1000
Error: Start frame must be less than or equal to end frame.

Enter scene file name: layout.vscene
Enter start frame: 1001
Enter end frame: 1050
Opening file: layout.vscene
Processing frames: 1001 to 1050
